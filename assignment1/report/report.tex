...
\newcommand{\theassingment}{IT Innovation and Change}
\newcommand{\thesubassignment}{Vision and Baseline Plan}
\newcommand{\shorttheassingment}{ITIaC}
%\newcommand{\thepaperauthor}{}
\newcommand{\personalid}{dzr440 - 19/06/1991}
\newcommand{\thesubject}{Individual Assignment}
...
\hspace*{-2.33cm}
David B. Gandrup (xxxXXX)\\
\hspace*{-2.33cm}
Sokratis S. Drosos (xxxXXX)\\
\hspace*{-2.33cm}
Bjarki Madsen (xxxXXX)\\
\hspace*{-2.33cm}
Niklas Høj (nwv762)\\
\vspace*{1cm}
\hspace*{-2.33cm}
